...
object FunctionalAssignment {
  ...
  /**
    *
    * @param liste1 => 'intiallist'  we are working on
    * @param accu =>  The foldl accumulator, start-value
    * @param func => A function that is a applied with the fold
    * @tparam val01 => type of the elemts
    * @tparam val02 => the type of the accumulator.
    * @return => returns the type of val02
    */
  def op[val01, val02](liste1: Seq[val01], accu: val02)(func: (val02,val01) => val02): val02 = liste1.foldLeft(accu)(func)
